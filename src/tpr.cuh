...
__device__ void tpr_inter(cg::thread_block tb, TPR_CU::Equation eq, float3 *bkup, TPR_CU::TPR_Params params);
__device__ void tpr_inter_global(cg::thread_block tb, TPR_CU::Equation eq, float3 *bkup, TPR_CU::TPR_Params params);
